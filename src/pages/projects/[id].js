...
export default function Blog({user, project}) {
    ...
    return (
        <>
            ...
            <Container>
                <Row>
                    ...
                    {(user && user.admin) && (
                        <Col xs={12} lg={4} className="d-flex align-items-center">
                            <a href={`/admin/blog/edit/${project.id}`} className="px-2"> 
                ...
                <br />
                <Container className="p-3 blog-display" dangerouslySetInnerHTML={{ __html: project.contentHTML  }} />
            </Container>
        </>
    );
}
